 ...
 */
MCP980X::MCP980X(uint8_t address) {
 ...
 * @details Set the pin to either continuously keep the alert pin active or only assert it until an MCU has reacted to it and cleared it using resetAlert()
 * @see setAlertLimits()
 * @see resetAlert()
